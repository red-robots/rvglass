...
class Vc_Settings {
	...
	public function initAdmin() {
		...
		add_settings_field( self::$field_prefix . 'content_types', __( "Content types", LANGUAGE_ZONE ), array(
				&$this,
				'content_types_field_callback'
			), $this->page . $tab_prefix, $this->option_group . $tab_prefix );

		add_settings_field( self::$field_prefix . 'groups_access_rules', __( "User groups access rules", LANGUAGE_ZONE ), array(
				&$this,
				'groups_access_rules_callback'
			), $this->page . $tab_prefix, $this->option_group . $tab_prefix );
		add_settings_field( self::$field_prefix . 'not_responsive_css', __( "Disable responsive content elements", LANGUAGE_ZONE ), array(
				&$this,
				'not_responsive_css_field_callback'
			), $this->page . $tab_prefix, $this->option_group . $tab_prefix );
		add_settings_field( self::$field_prefix . 'google_fonts_subsets', __( "Google fonts subsets", LANGUAGE_ZONE ), array(
				&$this,
		...
		add_settings_field( self::$field_prefix . 'use_custom', __( 'Use custom design options', LANGUAGE_ZONE ), array(
				&$this,
				'use_custom_callback'
		...
		add_settings_field( self::$field_prefix . 'margin', __( 'Elements bottom margin', LANGUAGE_ZONE ), array(
				&$this,
				'margin_callback'
		...
		add_settings_field( self::$field_prefix . 'gutter', __( 'Grid gutter width', LANGUAGE_ZONE ), array(
				&$this,
				'gutter_callback'
		...
		add_settings_field( self::$field_prefix . 'responsive_max', __( 'Mobile screen width', LANGUAGE_ZONE ), array(
				&$this,
		...
		add_settings_section( $this->option_group . $tab_prefix,
			...
			array( &$this, 'setting_section_callback_function' ),
			$this->page . $tab_prefix );
		add_settings_field( self::$field_prefix . 'custom_css', __( "Paste your CSS code", LANGUAGE_ZONE ), array(
				&$this,
		...
		$this->addField( $tab, __( 'Envato Username', LANGUAGE_ZONE ), 'envato_username', array(
				&$this,
				'sanitize_envato_username'
			), array( &$this, 'envato_username_callback' ) );
		$this->addField( $tab, __( 'Secret API Key', LANGUAGE_ZONE ), 'envato_api_key', array(
				&$this,
				'sanitize_envato_api_key'
			), array( &$this, 'envato_api_key_callback' ) );
		$this->addField( $tab, __( 'Visual Composer License Key', LANGUAGE_ZONE ), 'js_composer_purchase_code', array(
				&$this,
	...
	public function google_fonts_subsets_callback() {
		...
		?>
		<p
			class="description indicator-hint"><?php _e( "Select subsets for google fonts.", LANGUAGE_ZONE ); ?></p>
	<?php
	}
	...
	public function column_css_classes_callback() {
		...
		?>
		<?php // <p class="description indicator-hint"> _e("To change class names for the columns elements, enter them here. By default vc_col-sm-X are used, where X number from 1 to 12.", LANGUAGE_ZONE);</p> ?>
	<?php
	}
		...
		<?php elseif ( $tab["id"] == 'wpb_js_composer_settings_updater' ): ?>
			<div class="tab_intro">
				...
				<div class="updated inline">
					<p>
						<?php _e('Please activate your license in Product License tab!', LANGUAGE_ZONE) ?>
					</p>
				</div>
				<?php endif; ?>
				<p>
...
EOF;
						...
						<a href="#" class="button vc_restore-button"
						   id="vc_settings-custom-css-reset-data"><?php _e( 'Remove all saved', LANGUAGE_ZONE ) ?></a>
					</form>
				...
				<?php
					...
					<form action="options.php" method="post" id="vc_settings-<?php echo $tab ?>"
						...
						<?php if ( $tab == 'color' ): ?>
							<a href="#" class="button vc_restore-button"
							   id="vc_settings-color-restore-default"><?php _e( 'Restore to defaults', LANGUAGE_ZONE ) ?></a>
						<?php endif; ?>
						<?php if ( $tab === 'updater' ): ?>
							...
							<a href="#" class="button button-primary vc_activate-license-button"
							   id="vc_settings-activate-license"><?php empty( $license_activation_key ) ? _e( 'Activate license', LANGUAGE_ZONE ) : _e( 'Deactivate license', LANGUAGE_ZONE ) ?></a>
