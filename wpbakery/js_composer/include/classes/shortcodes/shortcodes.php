		...
		protected function singleParamEditForm( $param, $param_value ) {
			...
			if ( $param['type'] == 'textfield' ) {
				...
				foreach ( $values as $label => $v ) {
					...
					$param_line .= ' <label class="vc_checkbox-label"><input id="' . $param['param_name'] . '-' . $v . '" value="' . $v . '" class="wpb_vc_param_value ' . $param['param_name'] . ' ' . $param['type'] . '" type="checkbox" name="' . $param['param_name'] . '"' . $checked . '> ' . __( $label, LANGUAGE_ZONE ) . '</label>';
				}
				...
				foreach ( $post_types as $post_type ) {
					...
					if ( $post_type != 'attachment' ) {
						...
						$param_line .= ' <label class="vc_checkbox-label"><input id="' . $param['param_name'] . '-' . $post_type . '" value="' . $post_type . '" class="wpb_vc_param_value ' . $param['param_name'] . ' ' . $param['type'] . '" type="checkbox" name="' . $param['param_name'] . '"' . $checked . '> ' . $post_type . '</label>';
					}
				}
				...
				foreach ( $post_types as $type ) {
					...
					foreach ( $taxonomies as $tax ) {
						...
						$param_line .= ' <label class="vc_checkbox-label" data-post-type="' . $type . '"><input id="' . $param['param_name'] . '-' . $tax->name . '" value="' . $tax->name . '" data-post-type="' . $type . '" class="wpb_vc_param_value ' . $param['param_name'] . ' ' . $param['type'] . '" type="checkbox" name="' . $param['param_name'] . '"' . $checked . '> ' . $tax->label . '</label>';
					}
				}
			} // Exploded textarea
